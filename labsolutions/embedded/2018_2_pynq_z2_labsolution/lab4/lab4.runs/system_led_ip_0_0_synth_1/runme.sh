...
HD_PWD='D:/github/Embedded-System-Design-Flow-on-Zynq/labsolutions/embedded/2018_2_pynq_z2_labsolution/lab3/lab3.runs/system_led_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_led_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_led_ip_0_0.tcl
